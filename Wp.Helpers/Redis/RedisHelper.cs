    ...
    public class RedisHelper
    {
        ...
        public RedisHelper(int dbNum, string readWriteHosts)
        {
            ...
            _conn = string.IsNullOrWhiteSpace(readWriteHosts) ?
                    RedisCnnHelper.Instance :
                    RedisCnnHelper.GetConnectionMultiplexer(readWriteHosts);
        }
        ...
        /// <returns></returns>
        public bool ExistsHash(string key, string dataKey)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="dataKey"></param>
        /// <returns></returns>
        public string GetHash(string key, string dataKey)
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public IList<T> GetHashList<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public List<T> GetHashKeys<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void PushListRight<T>(string key, T value)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public T PopListRight<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void PushListLeft<T>(string key, T value)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public T PopListLeft<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<List<T>> GetListRangeAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public async Task<long> PushListRightAsync<T>(string key, T value)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<T> PopListRightAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public async Task<long> PushListLeftAsync<T>(string key, T value)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<T> PopListLeftAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public List<T> GetSortedSetRangeByRank<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(redis =>
            {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public long GetSortedSetLength(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="value"></param>
        /// <param name="score"></param>
        public async Task<bool> AddSortedSetAsync<T>(string key, T value, double score)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public async Task<bool> RemoveSortedSetAsync<T>(string key, T value)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<List<T>> GetSortedSetRangeByRankAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="expiry"></param>
        /// <returns></returns>
        public bool ExpireKey(string key, TimeSpan? expiry = default(TimeSpan?))
        {
            key = AddSysCustomKey(key);
        ...
        private static void GetMessage(RedisChannel channel, RedisValue message)
        {
        ...
        {
            var prefixKey = CustomKey ?? RedisCnnHelper.SysCustomKey;
